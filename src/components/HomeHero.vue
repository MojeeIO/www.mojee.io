<template>
    ...
    >
        <div class="md:w-1/2">
            ...
            >
                ...
                <div class="inline-flex items-center">
                    ...
                    >
                        <span class="relative leading-6 whitespace-no-wrap z-5">
                            Coming soon
                        </span>
                        <span
        ...
        <div class="flex-shrink-0 hidden w-full pl-10 md:block md:w-1/2">
            <home-hero-artwork />
        </div>
    </div>
</template>
